...
# Example S for testing (50 fps 18ms exposure): S 50 19000 500 0 1 1 1000
# Example S for testing (60 fps 15ms exposure): S 60 16000 500 0 1 1 1000
# Example S for testing (80 fps 12ms exposure): S 80 12400 200 0 1 1 1000
...
*/
#define LED1_PIN 0          // TTL to LED 1
#define LED2_PIN 1          // TTL to LED 2
#define FRAME_TTL_PIN 3     // Timestamp TTLs (i.e., to trigger the Camera) - pulsed after the specified offset time

#define CAMERA_PIN 6       // Camera TTL output (held high until Q is passed) - CURRENTLY UNUSED
#define END_TTL_PIN 7       // One-time TTL to mark session end time (upon pressing Q) - CURRENTLY UNUSED
#define EXT_TRIGGER_PIN 8  // Input pin if you want the camera and the timestamping ttls to start via external ttl instead of uart - CURRENTLY UNUSED
