...
if __name__ == "__main__":
    try:
        ...
        exp = LocallySparseNoiseExperiment(experiment_id, mouse_id, data_aq, "monitor_config.yaml", "config.yaml", "locally_sparse_noise_4deg_config.yaml", debug=bool_DEBUG)
