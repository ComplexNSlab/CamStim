...
###
    def get_exp_params(self):
        ...
        # print(exp_num, experiment_id, mouse_id)

        self.start_stim(exp_name, experiment_id, mouse_id)


    def start_stim(self, exp_name, experiment_id, mouse_id):
        if self.stim_progress is not None:
        ...
        self.stim_progress = subprocess.Popen(["python", "C:/Users/admin/source/simple-vs/wf_main.py", exp_name, experiment_id, mouse_id],
